#############################################################################
# Makefile for building: build/tiger-compiler
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = tiger-compiler1.0.0
DISTDIR = /home/maicon/work/uem/compiladores/tiger-compiler/build/tiger-compiler1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
QMAKE_TARGET  = tiger-compiler
DESTDIR       = build/
TARGET        = build/tiger-compiler


first: all
####### Build rules

build/tiger-compiler: src/tiger.lexer.cpp src/tiger.parser.cpp src/tiger.parser.hpp $(OBJECTS)  
...
all: Makefile build/tiger-compiler
...
build/main.o: src/main.cpp src/tiger.parser.hpp \
		src/ast/ast.hpp \
